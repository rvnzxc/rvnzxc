...
<a href="https://readme-typing-svg.demolab.com/">
  <img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=600&size=22&duration=2800&pause=900&color=A78BFA&center=true&vCenter=true&width=850&lines=BSIT+Student+%7C+Web+Developer;Laravel+%7C+Tailwind+CSS+%7C+JavaScript;React.js+%7C+Vue.js+%7C+PHP+%7C+SQL;Building+modern+and+responsive+web+applications;Open+to+Internships+%7C+Backend+Development" alt="Typing SVG" />
</a>
...
`Software Engineering Internships` · `Web Development Internships` · `Backend Development` · `Laravel Development` · `Full-Stack Development` · `Collaborative Projects`
...
<a href="https://www.java.com/"><img src="https://skillicons.dev/icons?i=java" /></a> <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript"><img src="https://skillicons.dev/icons?i=javascript" /></a> <a href="https://www.php.net/"><img src="https://skillicons.dev/icons?i=php" /></a> <a href="https://www.w3.org/html/"><img src="https://skillicons.dev/icons?i=html" /></a> <a href="https://www.w3.org/Style/CSS/"><img src="https://skillicons.dev/icons?i=css" /></a>
...
<a href="https://react.dev/"><img src="https://skillicons.dev/icons?i=react" /></a> <a href="https://vuejs.org/"><img src="https://skillicons.dev/icons?i=vue" /></a> <a href="https://tailwindcss.com/"><img src="https://skillicons.dev/icons?i=tailwind" /></a> <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript"><img src="https://skillicons.dev/icons?i=javascript" /></a> <a href="https://developer.mozilla.org/en-US/docs/Web/HTML"><img src="https://skillicons.dev/icons?i=html" /></a> <a href="https://developer.mozilla.org/en-US/docs/Web/CSS"><img src="https://skillicons.dev/icons?i=css" /></a>
...
<a href="https://laravel.com/"><img src="https://skillicons.dev/icons?i=laravel" /></a> <a href="https://www.php.net/"><img src="https://skillicons.dev/icons?i=php" /></a> <a href="https://www.mysql.com/"><img src="https://skillicons.dev/icons?i=mysql" /></a> <a href="https://www.apachefriends.org/"><img src="https://skillicons.dev/icons?i=apache" /></a>
...
<details>
<summary><strong>CoopPOS+ — Integrated Web Point of Sales & Purchase Analytics</strong></summary>

### CoopPOS+

A web-based point-of-sale and purchase analytics system designed to improve cooperative operations through centralized transaction, inventory, member, and purchasing data.

| Metric          | Engineering Scope                                                           |
| :-------------- | :-------------------------------------------------------------------------- |
| **Stack**       | Laravel · PHP · MySQL · JavaScript · HTML · CSS · Tailwind CSS              |
| **Scale**       | Cooperative point-of-sale environment                                       |
...
* Developed a web-based POS system concept
* Designed inventory management workflows
* Integrated member records with purchase transactions
* Planned barcode-based member and product identification
* Designed purchase analytics and transaction history
* Structured relational data using MySQL
* Focused on maintainability and practical business workflows

</details>

<details>
<summary><strong>Web-Based Coffee Shop HR & Record Management Platform</strong></summary>

### Coffee Shop HR Platform

A web-based employee information and record-management platform designed to organize employee profiles, documents, and administrative records.

| Metric          | Engineering Scope                                           |
| :-------------- | :---------------------------------------------------------- |
| **Stack**       | PHP · MySQL · JavaScript · HTML · CSS · Tailwind CSS        |
| **Scale**       | Small-to-medium business environment                        |
...
* Designed employee profile management workflows
* Planned document submission functionality
* Structured employee data and records
* Designed responsive interfaces
* Focused on usability and maintainable system architecture

</details>

<details>
<summary><strong>Hybrid Student Transaction Management System</strong></summary>

### Student Transaction Management System

A web-based appointment and queue management system concept designed to improve student transactions within an academic registrar environment.

| Metric          | Engineering Scope                                               |
| :-------------- | :-------------------------------------------------------------- |
| **Stack**       | PHP · MySQL · JavaScript · HTML · CSS                           |
| **Scale**       | Academic office environment                                     |
...
* Designed digital appointment workflows
* Planned queue monitoring functionality
* Structured student transaction records
* Applied system analysis and design principles
* Focused on improving service efficiency and user experience
...
Developing academic and personal projects focused primarily on **web development, backend systems, databases, and software engineering fundamentals**.

**Scope of Work**

* Develop database-driven web applications
* Build backend functionality using PHP and Laravel
* Create responsive interfaces using HTML, CSS, JavaScript, and Tailwind CSS
* Explore component-based development using React.js and Vue.js
* Design and manage SQL databases
* Work with XAMPP for local PHP and MySQL development
* Develop Java applications for programming and software development exercises
* Analyze system requirements and translate them into functional application features
* Practice Git and GitHub-based development workflows
* Debug, test, and continuously improve application functionality
...
| Recognition              | Details                                                                                     |
| :----------------------- | :------------------------------------------------------------------------------------------ |
| **Web Development**      | Built multiple web-based systems focused on real-world organizational workflows             |
...
profile:
  ...
  goal: "Build reliable and modern web applications"
...
<strong>“Build with purpose. Learn continuously. Ship better software.”</strong>
